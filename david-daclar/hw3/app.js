...
// Answer Starts Here
  // 'Calendar'
  // Description: Our app is a browser-based calendar program for keeping track of things.
  // Every 'calendar item' has
  // - a Date
  // - a time
  // - a note
  // Every 'calendar' item can
  // - add
  // - edit
  // - delete
