...
function fahrenheitCelsius() {
   let fTemp = document.getElementById('temperature').value;
   console.log(fTemp);
   result = (fTemp - 32) / 1.8;
   console.log(result);
...
function celsiusFahrenheit() {
   let cTemp = document.getElementById('temperature').value;
   result = 1.8 * cTemp + 32;
   document.getElementById('result').innerHTML = result;
   document.getElementById('temperature').value = '';
}

document.getElementById('fahrenheit_to_celsius').addEventListener('click', fahrenheitCelsius);
document.getElementById('celsius_to_fahrenheit').addEventListener('click', celsiusFahrenheit);
