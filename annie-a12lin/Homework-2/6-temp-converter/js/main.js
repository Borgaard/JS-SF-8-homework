...
/* HOMEWORK #1 BELOW
let fahrenheit = window.prompt("What temperature in Fahrenheit do you want to convert to Celsius?");
...
/* HOMEWORK #2 BELOW
let celsius = window.prompt("What temperature in Celsius do you want to convert to Fahrenheit?");
