...
function convertFtoC(temperature) {
  var temp = (temperature - 32) / 1.8;
  console.log(temp);
  return temp;
}

function convertCtoF(temperature) {
  var temp = 1.8 * temperature + 32;
  console.log(temp);
  return temp;
}
...
document.getElementById("fahrenheit_to_celsius").addEventListener("click", function() {
  document.querySelector('#result').innerHTML = convertFtoC(temperature.value);
  temperature.value = '';
});

document.getElementById("celsius_to_fahrenheit").addEventListener("click", function() {
  document.querySelector('#result').innerHTML = convertCtoF(temperature.value);
  temperature.value = '';
});

//
// document.addEventListener("click", function(){
//     document.getElementById("fahrenheit_to_celsius").innerHTML = "Hello World";
// });
