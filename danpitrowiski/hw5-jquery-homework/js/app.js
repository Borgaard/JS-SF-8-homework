...
$(function(){
	$("#surveyList li").append("<button>Remove question</button>");
...
// });
	...
	$('#surveyBuilder #addQuestion').on('submit click', function(e){
		var question = $( '#question' ).val();
		$("#surveyList").append('<li class="form-group padout"><label>'+question+'</label><input type="text" class="form-control"><button>Remove question</button></li>');
		$('#question').val('');
		return false;
	});
});
