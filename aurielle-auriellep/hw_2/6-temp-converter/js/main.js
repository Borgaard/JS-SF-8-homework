...
function toCelcius(fahrenheitInput) {
    const celcius = (fahrenheitInput - 32) / 1.8;
    return celcius.toFixed(0);
};

function toFahrenheit(celciusInput) {
    fahrenheit = (1.8 * celciusInput) + 32;
...
$(document).ready(function() {
    ...
    $("button#fahrenheit_to_celsius").on('click', function() {
        const input = $("input").val();
        console.log($("input").val());
        const result = toCelcius(input);
        console.log('you changed ' + $("input").val());
        $("input").val('')
        $("#result").html(`Result: ${result}`);
    });
    $("button#celsius_to_fahrenheit").on('click', function() {
        const input = $("input").val();
        console.log($("input").val());
        const result = toFahrenheit(input);
        console.log('you changed ' + $("input").val());
        $("input").val('')
        $("#result").html(`Result: ${result}`);
